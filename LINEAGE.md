...
- 각 시점의 릴리스 노트는 `docs/releases/RELEASE_NOTES_*.md`로 남아 있습니다.
- 포크에서 물려받은 식별자 중 무엇을 그대로 두고 무엇을 바꿨는지는 [docs/lineage-identifiers.md](docs/lineage-identifiers.md)에 정리돼 있습니다.
